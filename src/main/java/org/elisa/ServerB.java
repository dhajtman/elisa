...
public class ServerB {
    ...
    public static final String FILE_PATH = "/dracula.txt";

    public static void main(String[] args) {
        if (ServerB.class.getResource(FILE_PATH) == null) {
        ...
        try (ServerSocket serverSocket = new ServerSocket(PORT)) {
            ...
            while (true) {
                try (Socket clientSocket = serverSocket.accept();
                    ...
                    LOGGER.info("Client connected to ServerB from " + clientSocket.getInetAddress());
                    String line;
